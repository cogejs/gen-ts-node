    ...
    return [
      {
        ...
        default: ((_a = this._pkg) === null || _a === void 0 ? void 0 : _a.name)
          ? this._pkg.name
          : AppName,
      },
      {
        ...
        default: (
          (_b = this._pkg) === null || _b === void 0 ? void 0 : _b.description
        )
      ...
      },
      {
        ...
        message:
          'Email of the owner?' +
          chalk_1.default.gray(' (for setting package.json)'),
